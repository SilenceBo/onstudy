...
;(function(root, factory) {
    ...
    jedfn.generateHtml = function(opts,boxCell){
        ...
        var botStrHtml = '<div class="botflex jedatehmsshde"><ul class="jedatehms"><li><input style="cursor: pointer;" maxlength="2" numval="23" hms="0"></li><i>:</i><li><input style="cursor: pointer;" maxlength="2" numval="59" hms="1"></li><i>:</i><li><input style="cursor: pointer;" maxlength="2" numval="59" hms="2"></li></ul></div>' +
        ...
        if(/\hh/.test(jet.format)) {
            ...
            $.each(["hh", "mm", "ss"], function (i, hms) {
                ...
                inphms.val(undezz ? "00":jet.digit(hmsobj[hms])).attr("readOnly",jet.isBool(opts.ishmsVal) ? false:true).attr("cursor","pointer");
